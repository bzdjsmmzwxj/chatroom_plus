...
public class FriendsList {
    ...
    //侦听好友上线信息、用户私聊、群聊
    private class DaemonTak implements Runnable{
    ...
    public FriendsList(String userName, Set<String> users, Connect2Server connect2Server){
        ...
        loadUsers();
        //启动后台线程不断监听服务器发来的消息
        Thread daemonThread = new Thread(new DaemonTak());
    ...
    private void loadUsers() {
        ...
        friends.setLayout(new BoxLayout(friends,
                BoxLayout.Y_AXIS));
        //set遍历
        ...
        //设置滚动条垂直滚动
        friendsList.setHorizontalScrollBarPolicy(JScrollPane.
